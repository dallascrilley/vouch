...
| P0-8 | Docker cold-start smoke: health + simulated review verdict | B | **validated** | `script/validate-docker-smoke`; CI `docker-smoke` workflow (2026-06-15 green on PR #21) |
